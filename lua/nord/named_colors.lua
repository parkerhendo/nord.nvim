local nord = {
	...
	glacier = "#81A1C1", -- nord9 in palette // duplicate of the above color so I don't need to edit the rest of the theme def
	blue = "#5E81AC", -- nord10 in palette   // duplicate of the above color so I don't need to edit the rest of the theme def
